...
namespace FS.Utils.Web.Component
{
    ...
    public abstract class BaseVeriCode
    {
        ...
        /// <returns></returns>
        protected static void ResponseImage(HttpContext context, string code, Color backColor, int fontSize = 12, int imgWidth = 60, int imgHeiht = 20, int stainLenght = 30, Pen borderColor = null)
        {
            if (borderColor == null)
            {
