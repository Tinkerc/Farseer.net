...
namespace FS.Utils.Web.Common
{
    ...
    public abstract class Req
    {
        ...
        {
            return HttpContext.Current == null ? defValue : Webs.UrlDecode(HttpContext.Current.Request.QueryString[parmsName] ?? string.Empty).ConvertType(defValue);
        }
        ...
        {
            return string.IsNullOrWhiteSpace(QF(parmsName)) ? QS(parmsName, defValue) : QF(parmsName, defValue);
        }
