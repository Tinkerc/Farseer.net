...
namespace FS.Core.Infrastructure
{
        ...
        where TEntity : class, new()
    {
        ...
        public TSet Select<T>(Expression<Func<TEntity, T>> select)
        {
        ...
        public TSet Where(Expression<Func<TEntity, bool>> where)
        {
        ...
        /// </summary>
        /// <param name="where">查询条件</param>
        public TSet Where<T>(Expression<Func<IEntity<T>, bool>> where)
        {
            Queue.AddWhere(where);
            return (TSet)this;
        }
        ...
        public TSet Desc<TKey>(Expression<Func<TEntity, TKey>> desc)
        {
        ...
        public TSet Asc<TKey>(Expression<Func<TEntity, TKey>> asc)
        {
